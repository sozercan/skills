...
| [`autoreview`](skills/autoreview/SKILL.md) | Structured closeout code review minimally adapted from OpenClaw. Defaults to Codex `gpt-6-astra` and Claude `claude-opus-5`, both with `max` reasoning. |
