...
| [`autoreview`](skills/autoreview/SKILL.md) | Hardened structured code-review closeout for local, commit, branch, and PR changes. Defaults to Codex `gpt-5.6-sol` with `max` reasoning unless the user overrides it. |
