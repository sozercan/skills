...
| [`autoreview`](skills/autoreview/SKILL.md) | Structured closeout code review synchronized from OpenClaw. Defaults to Codex `gpt-5.6-sol` with `high` reasoning unless the user overrides it. |
